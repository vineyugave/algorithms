...
public class Ex_1_3_08 implements Iterable<String> {
    private String[] a;
    private int N;
    ...
    public static void main(String[] args) {
        ...
        while (!StdIn.isEmpty()) {
            ...
            StdOut.println("Array Size : " + s.getArraySize());
            StdOut.println("a : " + Arrays.toString(s.getA()));
        }
    }
}
